	...
	var infiniScroll = function (viewOptions, options) {
		var $this = this;
	 ...
	 */
		...
		startHeightCheck: function(){
			...
			var $this = this, currentTime = 0; 
			
			var checkInterval = setInterval(function(){
				if ((currentTime += 100) > $this.options.timeout) 
